...
void	test_WrongAnimal( void )
{
	...
	std::cout << C_GREEN"const WrongAnimal* wrongAAnimal"C_DEFAULT << std::endl;
	const WrongAnimal* wrongAAnimal = new WrongAnimal();
	std::cout << std::endl;
	std::cout << C_GREEN"const WrongAnimal* wrongAAnimalCat"C_DEFAULT << std::endl;
	...
	std::cout << C_RED"wrongAAnimal"C_DEFAULT << std::endl;
	delete wrongAAnimal;
	std::cout << std::endl;
	std::cout << C_RED"wrongAAnimalCat"C_DEFAULT << std::endl;
...
{
	print_title( "Constructors", C_GREEN, C_YELLOW );
	//std::cout << C_GREEN"const AAnimal* animal"C_DEFAULT << std::endl;
	//const AAnimal* animal = new AAnimal();
	//std::cout << std::endl;
	std::cout << C_GREEN"const AAnimal* animalDog"C_DEFAULT << std::endl;
	const AAnimal* animalDog = new Dog();
	std::cout << std::endl;
	std::cout << C_GREEN"const AAnimal* animalCat"C_DEFAULT << std::endl;
...
void	test_Animal_basic_v2( AAnimal* animals[], unsigned short int size, unsigned int c_size, unsigned short int (*cmp)( unsigned int , unsigned int ) )
{
	...
	{
		lower = cmp( i, size );
		std::cout << C_PURPLE"AAnimal* animals[ "C_WHITE << i << C_PURPLE" ]"C_WHITE << std::endl;
		switch ( lower )
		{
			case 1:
...
void	test_Animal_v2( unsigned short int size )
{
	...
	c_size = size * 2;
	print_title( "Constructors", C_GREEN, C_YELLOW );
	std::cout << C_GREEN"AAnimal* animals[ "C_WHITE << c_size << C_GREEN" ]"C_DEFAULT << std::endl;
	...
	for ( unsigned int i = 0; i < c_size; i++ )
	{
		...
		{
			case 1:
				std::cout << C_GREEN"AAnimal* animals[ "C_WHITE << i << C_GREEN" ] = new Cat()"C_DEFAULT << std::endl;
				animals[ i ] = new Cat();
				dynamic_cast<Cat *>(animals[ i ])->addIdea( "Exploding Kittens" );
				break ;
			default:
				std::cout << C_GREEN"AAnimal* animals[ "C_WHITE << i << C_GREEN" ] = new Dog()"C_DEFAULT << std::endl;
				animals[ i ] = new Dog();
