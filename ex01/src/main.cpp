...
/*   Updated: 2023/07/11 13:09:17 by eralonso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define C_PURPLE	"\033[1;95m"
#define C_CYAN		"\033[1;96m"
#define C_PINK		"\033[1;95;34m"
...
int	main( void )
{
	print_title( "Test: Animal V.1", C_RED, C_PINK );
	test_Animal_v1();
	print_title( "Test: WrongAnimal", C_RED, C_PINK );
	test_WrongAnimal();
	print_title( "Test: Animal V.2", C_RED, C_PINK );
	test_Animal_v2( 5 );
	return ( 0 );
}
